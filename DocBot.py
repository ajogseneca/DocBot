        ...
        if args.output == "cli_print":
            ...
            with open(args.output, 'w') as output_file:
                for file in args.files:
                    ...
                    generate_readme(file, args.output, api_key=args.api_key)
